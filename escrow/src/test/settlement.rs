...
fn test_claim_investor_twice_is_idempotent() {
    ...
    client.init(
        &admin,
        &String::from_strsoroban_sdk::String::from_str(&env, "CL001"),
        &sme,
        &1_000i128,
        &400i64,
        &0u64,
...
fn test_claim_by_non_investor_panics() {
    ...
    client.init(
        &admin,
        &String::from_strsoroban_sdk::String::from_str(&env, "STR001"),
        &sme,
        &1_000i128,
        &400i64,
        &0u64,
...
fn test_clashing_investors_have_independent_claims() {
    ...
    client.init(
        &admin,
        &String::from_strsoroban_sdk::String::from_str(&env, "CLASH01"),
        &sme,
        &2_000i128,
        &400i64,
        &0u64,
...
fn test_claim_gating_exact_timestamp() {
    ...
    client.init(
        &admin,
        &String::from_strsoroban_sdk::String::from_str(&env, "LOCK003"),
        &sme,
        &1_000i128,
        &400i64,
        &0u64,
...
fn test_claim_gating_with_multiple_investors() {
    ...
    client.init(
        &admin,
        &String::from_strsoroban_sdk::String::from_str(&env, "LOCK004"),
        &sme,
        &2_000i128,
        &400i64,
        &0u64,
...
fn settle_with_maturity_zero_succeeds_immediately() {
    ...
    client.init(
        &admin,
        &String::from_strsoroban_sdk::String::from_str(&env, "MAT001"),
        &sme,
        &TARGET,
        &800i64,
        &0u64, // maturity = 0
...
fn settle_maturity_zero_event_maturity_field_is_zero() {
    ...
    client.init(
        &admin,
        &String::from_strsoroban_sdk::String::from_str(&env, "MAT002"),
        &sme,
        &TARGET,
        &800i64,
        &0u64,
...
fn settle_before_maturity_panics() {
    ...
    client.init(
        &admin,
        &String::from_strsoroban_sdk::String::from_str(&env, "MAT003"),
        &sme,
        &TARGET,
        &800i64,
        &maturity_ts,
...
fn settle_at_maturity_succeeds() {
    ...
    client.init(
        &admin,
        &String::from_strsoroban_sdk::String::from_str(&env, "MAT004"),
        &sme,
        &TARGET,
        &800i64,
        &maturity_ts,
...
fn settle_after_maturity_succeeds() {
    ...
    client.init(
        &admin,
        &String::from_strsoroban_sdk::String::from_str(&env, "MAT005"),
        &sme,
        &TARGET,
        &800i64,
        &maturity_ts,
...
fn settle_emits_escrow_settled_event() {
    ...
    client.init(
        &admin,
        &String::from_strsoroban_sdk::String::from_str(&env, "EVT001"),
        &sme,
        &TARGET,
        &yield_bps,
        &maturity_ts,
...
fn settle_blocked_by_legal_hold_when_maturity_not_reached() {
    ...
    client.init(
        &admin,
        &String::from_strsoroban_sdk::String::from_str(&env, "LHMAT01"),
        &sme,
        &TARGET,
        &800i64,
        &maturity_ts,
...
fn claim_investor_payout_succeeds_after_settle() {
    ...
    client.init(
        &admin,
        &String::from_strsoroban_sdk::String::from_str(&env, "SW003"),
        &sme,
        &1_000i128,
        &100i64,
        &0u64,
...
fn claim_investor_payout_twice_panics() {
    ...
    client.init(
        &admin,
        &String::from_strsoroban_sdk::String::from_str(&env, "SW004"),
        &sme,
        &1_000i128,
        &100i64,
        &0u64,
...
fn claim_investor_payout_before_settle_panics() {
    ...
    client.init(
        &admin,
        &String::from_strsoroban_sdk::String::from_str(&env, "SW005"),
        &sme,
        &1_000i128,
        &100i64,
        &0u64,
...
fn claim_investor_payout_non_participant_panics() {
    ...
    client.init(
        &admin,
        &String::from_strsoroban_sdk::String::from_str(&env, "SW006"),
        &sme,
        &1_000i128,
        &100i64,
        &0u64,
...
fn funding_snapshot_survives_withdraw() {
    ...
    client.init(
        &admin,
        &String::from_strsoroban_sdk::String::from_str(&env, "SW007"),
        &sme,
        &TARGET,
        &100i64,
        &0u64,
...
fn test_is_investor_claimed_false_before_any_claim() {
    ...
    client.init(
        &admin,
        &String::from_strsoroban_sdk::String::from_str(&env, "GIC001"),
        &sme,
        &1_000i128,
        &400i64,
        &0u64,
...
fn test_is_investor_claimed_returns_false_for_unfunded_address() {
    ...
    client.init(
        &admin,
        &String::from_strsoroban_sdk::String::from_str(&env, "GIC002"),
        &sme,
        &1_000i128,
        &400i64,
        &0u64,
...
fn test_claim_marker_persists_after_claim() {
    ...
    client.init(
        &admin,
        &String::from_strsoroban_sdk::String::from_str(&env, "GIC003"),
        &sme,
        &1_000i128,
        &400i64,
        &0u64,
...
fn test_claim_marker_isolated_per_investor() {
    ...
    client.init(
        &admin,
        &String::from_strsoroban_sdk::String::from_str(&env, "GIC004"),
        &sme,
        &2_000i128,
        &400i64,
        &0u64,
...
fn test_claim_marker_all_investors_independent() {
    ...
    client.init(
        &admin,
        &String::from_strsoroban_sdk::String::from_str(&env, "GIC005"),
        &sme,
        &3_000i128,
        &400i64,
        &0u64,
