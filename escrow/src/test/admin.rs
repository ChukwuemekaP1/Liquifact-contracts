...
fn test_update_maturity_success() {
    ...
    client.init(
        &admin,
        &String::from_strsoroban_sdk::String::from_str(&env, "INV006b"),
        &sme,
        &1_000i128,
        &500i64,
        &0u64,
...
fn test_update_maturity_wrong_state() {
    ...
    client.init(
        &admin,
        &String::from_strsoroban_sdk::String::from_str(&env, "INV007"),
        &sme,
        &1_000i128,
        &500i64,
        &0u64,
...
fn test_update_maturity_unauthorized() {
    ...
    client.init(
        &admin,
        &String::from_strsoroban_sdk::String::from_str(&env, "INV009"),
        &sme,
        &1_000i128,
        &500i64,
        &0u64,
...
fn test_transfer_admin_updates_admin() {
    ...
    client.init(
        &admin,
        &String::from_strsoroban_sdk::String::from_str(&env, "T001"),
        &sme,
        &TARGET,
        &800i64,
        &1000u64,
...
fn test_transfer_admin_same_address_panics() {
    ...
    client.init(
        &admin,
        &String::from_strsoroban_sdk::String::from_str(&env, "T002"),
        &sme,
        &TARGET,
        &800i64,
        &1000u64,
...
fn test_record_collateral_stored_and_does_not_block_settle() {
    ...
    client.init(
        &admin,
        &String::from_strsoroban_sdk::String::from_str(&env, "COL001"),
        &sme,
        &TARGET,
        &800i64,
        &0u64,
...
fn test_collateral_zero_panics() {
    ...
    client.init(
        &admin,
        &String::from_strsoroban_sdk::String::from_str(&env, "COL002"),
        &sme,
        &TARGET,
        &800i64,
        &0u64,
...
fn test_collateral_requires_sme_auth() {
    ...
    client.init(
        &admin,
        &String::from_strsoroban_sdk::String::from_str(&env, "COL003"),
        &sme,
        &TARGET,
        &800i64,
        &0u64,
...
fn test_legal_hold_blocks_settle_withdraw_claim_and_fund() {
    ...
    client.init(
        &admin,
        &String::from_strsoroban_sdk::String::from_str(&env, "LH001"),
        &sme,
        &TARGET,
        &800i64,
        &0u64,
...
fn test_legal_hold_blocks_new_funds_when_open() {
    ...
    client.init(
        &admin,
        &String::from_strsoroban_sdk::String::from_str(&env, "LH002"),
        &sme,
        &TARGET,
        &800i64,
        &0u64,
...
fn test_update_funding_target_fails_when_settled() {
    ...
    client.init(
        &admin,
        &String::from_strsoroban_sdk::String::from_str(&env, "SETL001"),
        &sme,
        &5_000i128,
        &800i64,
        &0u64,
...
fn test_update_funding_target_fails_when_withdrawn() {
    ...
    client.init(
        &admin,
        &String::from_strsoroban_sdk::String::from_str(&env, "WD001"),
        &sme,
        &5_000i128,
        &800i64,
        &0u64,
...
fn test_update_funding_target_equal_to_funded_amount_succeeds() {
    ...
    client.init(
        &admin,
        &String::from_strsoroban_sdk::String::from_str(&env, "BOUND001"),
        &sme,
        &10_000i128,
        &800i64,
        &0u64,
...
fn test_update_funding_target_negative_panics() {
    ...
    client.init(
        &admin,
        &String::from_strsoroban_sdk::String::from_str(&env, "NEG001"),
        &sme,
        &5_000i128,
        &800i64,
        &0u64,
